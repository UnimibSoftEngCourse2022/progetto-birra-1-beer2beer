...
import com.example.beer2beer.databinding.DialogAddEquipmentBinding
import com.example.beer2beer.databinding.DialogAddIngredientsBinding

class AddEquipmentDialogFragment (private val equipmentName: String, private val equipmentQuantity: Double) : DialogFragment() {

    // Use this instance of the interface to deliver action events
    internal lateinit var listener: DialogListener
    interface DialogListener {
        fun onDialogSaveClick(name: String, category: String, quantity: Double)
    }
    ...
    private lateinit var binding: DialogAddEquipmentBinding

    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {

        // Set up the binding object
        binding = DataBindingUtil.inflate(layoutInflater, R.layout.dialog_add_equipment, null, false)

        // Set up the info to display in the dialog
        binding.equipmentNameEditText.setText(equipmentName)

        binding.quantityEditText.setText(equipmentQuantity.toString())
        ...
        return activity?.let {
            ...
            builder.setView(binding.root)
                .setPositiveButton(R.string.saveDialogButton) { _, _ ->
                    ...
                    listener.onDialogSaveClick(binding.equipmentNameEditText.text.toString(), binding.spinner.selectedItem.toString(), quantity)
                }
